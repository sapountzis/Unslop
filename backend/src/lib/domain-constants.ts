...
export const PLAN_STATUS_VALUES = ['inactive', 'active', 'canceled', 'past_due'] as const;
...
export type PolarSubscriptionStatusValue = (typeof POLAR_SUBSCRIPTION_STATUS_VALUES)[number];
