...
export const MULTIMODAL_MAX_NODE_COUNT = 12;
export const MULTIMODAL_MAX_NODE_DEPTH = 4;
export const MULTIMODAL_MAX_ATTACHMENTS = 8;
export const MULTIMODAL_MAX_IMAGE_BYTES = 2_000_000;
export const MULTIMODAL_MAX_PDF_EXCERPT_CHARS = 2_000;
