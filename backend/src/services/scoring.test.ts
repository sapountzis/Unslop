...
function scores(partial: Partial<ScoreResult>): ScoreResult {
    return {
        u: 0, d: 0, c: 0, rb: 0, eb: 0, sp: 0, p: 0, x: 0,
        ...partial,
    };
}
...
describe('audit metadata', () => {
    it('reports max signal and max noise correctly', () => {
        const out = engine.score(scores({ u: 0.8, d: 0.3, c: 0.5, rb: 0.2, eb: 0.4, p: 0.1 }));
...
describe('prompt example regression', () => {
    const examples: Array<{ name: string; scores: Partial<ScoreResult>; expected: 'keep' | 'hide' }> = [
        { name: 'Ex1: tech deep-dive', scores: { u: 0.9, d: 0.9, c: 0.5, rb: 0.0, eb: 0.2, sp: 0.0, p: 0.1, x: 0.0 }, expected: 'keep' },
        { name: 'Ex2: enthusiastic useful', scores: { u: 0.8, d: 0.6, c: 0.7, rb: 0.0, eb: 0.1, sp: 0.0, p: 0.2, x: 0.0 }, expected: 'keep' },
        { name: 'Ex3: empty hype tips', scores: { u: 0.1, d: 0.0, c: 0.3, rb: 0.3, eb: 0.6, sp: 0.0, p: 0.8, x: 0.2 }, expected: 'hide' },
        { name: 'Ex4: rejection story', scores: { u: 0.6, d: 0.3, c: 0.9, rb: 0.0, eb: 0.1, sp: 0.0, p: 0.2, x: 0.0 }, expected: 'keep' },
        { name: 'Ex5: humblebrag flex', scores: { u: 0.2, d: 0.0, c: 0.2, rb: 0.3, eb: 0.9, sp: 0.0, p: 0.7, x: 0.1 }, expected: 'hide' },
        { name: 'Ex6: constructive opinion', scores: { u: 0.8, d: 0.6, c: 0.6, rb: 0.1, eb: 0.2, sp: 0.0, p: 0.1, x: 0.0 }, expected: 'keep' },
        { name: 'Ex7: rage standups', scores: { u: 0.3, d: 0.2, c: 0.1, rb: 0.9, eb: 0.5, sp: 0.0, p: 0.4, x: 0.1 }, expected: 'hide' },
        { name: 'Ex8: sales funnel', scores: { u: 0.7, d: 0.5, c: 0.4, rb: 0.0, eb: 0.2, sp: 0.8, p: 0.3, x: 0.0 }, expected: 'hide' },
        { name: 'Ex9: robin hood funnel', scores: { u: 0.2, d: 0.1, c: 0.2, rb: 0.4, eb: 0.6, sp: 0.9, p: 0.7, x: 0.2 }, expected: 'hide' },
        { name: 'Ex10: modest tip', scores: { u: 0.5, d: 0.2, c: 0.5, rb: 0.0, eb: 0.0, sp: 0.0, p: 0.2, x: 0.0 }, expected: 'keep' },
        { name: 'Ex11: manufactured drama', scores: { u: 0.2, d: 0.1, c: 0.2, rb: 0.4, eb: 0.8, sp: 0.0, p: 0.8, x: 0.2 }, expected: 'hide' },
        { name: 'Ex12: engagement farming', scores: { u: 0.0, d: 0.0, c: 0.2, rb: 0.0, eb: 0.1, sp: 0.3, p: 0.9, x: 0.0 }, expected: 'hide' },
        { name: 'Ex13: "I\'m shaking" template', scores: { u: 0.1, d: 0.0, c: 0.2, rb: 0.2, eb: 0.8, sp: 0.8, p: 0.9, x: 0.3 }, expected: 'hide' },
        { name: 'Ex14: microservices criticism', scores: { u: 0.9, d: 0.8, c: 0.6, rb: 0.1, eb: 0.2, sp: 0.0, p: 0.0, x: 0.0 }, expected: 'keep' },
        { name: 'Ex15: health genuine advice', scores: { u: 0.8, d: 0.6, c: 0.8, rb: 0.0, eb: 0.1, sp: 0.0, p: 0.1, x: 0.0 }, expected: 'keep' },
        { name: 'Ex16: health pseudoscience', scores: { u: 0.1, d: 0.0, c: 0.2, rb: 0.5, eb: 0.3, sp: 0.2, p: 0.6, x: 0.9 }, expected: 'hide' },
        { name: 'Ex17: political nuance', scores: { u: 0.7, d: 0.6, c: 0.6, rb: 0.2, eb: 0.1, sp: 0.0, p: 0.2, x: 0.1 }, expected: 'keep' },
        { name: 'Ex18: political rage bait', scores: { u: 0.0, d: 0.0, c: 0.1, rb: 0.9, eb: 0.7, sp: 0.0, p: 0.5, x: 0.3 }, expected: 'hide' },
        { name: 'Ex19: genuine product review', scores: { u: 0.7, d: 0.5, c: 0.6, rb: 0.0, eb: 0.1, sp: 0.1, p: 0.1, x: 0.0 }, expected: 'keep' },
        { name: 'Ex20: shill product review', scores: { u: 0.1, d: 0.0, c: 0.1, rb: 0.2, eb: 0.3, sp: 0.9, p: 0.8, x: 0.5 }, expected: 'hide' },
        { name: 'Ex21: sarcastic humor', scores: { u: 0.2, d: 0.1, c: 0.7, rb: 0.2, eb: 0.0, sp: 0.0, p: 0.0, x: 0.0 }, expected: 'keep' },
        { name: 'Ex22: wholesome reaction', scores: { u: 0.0, d: 0.0, c: 0.8, rb: 0.0, eb: 0.0, sp: 0.0, p: 0.0, x: 0.0 }, expected: 'keep' },
        { name: 'Ex23: community help', scores: { u: 0.5, d: 0.4, c: 0.6, rb: 0.0, eb: 0.0, sp: 0.0, p: 0.0, x: 0.0 }, expected: 'keep' },
        { name: 'Ex24: parenting share', scores: { u: 0.1, d: 0.0, c: 0.9, rb: 0.0, eb: 0.0, sp: 0.0, p: 0.0, x: 0.0 }, expected: 'keep' },
    ];
