...
function getObserverFactory(
  ...
  return (callback, options) => new globalThis.IntersectionObserver(callback, options);
}

export function createVisibilityIndex(options?: VisibilityIndexOptions): VisibilityIndex {
