...
describe('x parser', () => {
    ...
    describe('extractPostData', () => {
        ...
        it('extracts quote tweet as repost node', async () => {
            ...
            const quoteTextEl = { textContent: 'Quoted content here', closest: () => quoteWrapper };
            ...
            const el = makeElement({
                ...
                querySelector: (s) => {
                    ...
                    if (s === '[data-testid="User-Name"]') {
                        return {
                            querySelector: (inner: string) => {
                                if (inner === 'a[href^="/"]') return { getAttribute: () => '/bob' };
                ...
                querySelector: (s) => {
                    ...
                    if (s === '[data-testid="User-Name"]') {
                        return {
                            querySelector: (inner: string) => {
                                if (inner === 'a[href^="/"]') {
                                    return { getAttribute: (name: string) => name === 'href' ? '/user123' : null };
                                }
                                if (inner === 'span') {
                    ...
                    if (s === 'a[href*="/status/"]') {
                        return { getAttribute: (name: string) => name === 'href' ? '/user123/status/456' : null };
                    }
                    return null;
                },
                querySelectorAll: (s) => {
        ...
        it('extracts quote tweet that uses role="link" pattern', async () => {
            ...
            const quoteTextEl = { textContent: 'Quoted tweet content', closest: () => quoteWrapper };
                ...
                querySelector: (s) => {
                    ...
                    if (s === '[data-testid="User-Name"]') {
                        return {
                            querySelector: (inner: string) => {
                                if (inner === 'a[href^="/"]') {
                                    return { getAttribute: (name: string) => name === 'href' ? '/greg' : null };
                                }
                                if (inner === 'span') {
                    ...
                    if (s === 'a[href*="/status/"]') {
                        return { getAttribute: (name: string) => name === 'href' ? '/greg/status/789' : null };
                    }
                    return null;
                },
                querySelectorAll: (s) => {
        ...
        it('extracts quote tweet with image attachment', async () => {
            ...
            const quoteWrapperEl = {
                ...
                querySelectorAll: (inner: string) => {
                    if (inner === '[data-testid="tweetPhoto"]') {
                        return [{
                            querySelector: (sel: string) => (sel === 'img' ? quoteTweetImage : null),
                ...
                contains: (e: unknown) => {
                    ...
                    return (e !== null && typeof e === 'object' && 'querySelector' in e) || e === quoteTextEl;
                },
            };
            ...
            const quoteTextEl = { textContent: 'Amazing screenshot attached', closest: () => quoteWrapperEl };
                ...
                querySelector: (s) => {
                    ...
                    if (s === '[data-testid="User-Name"]') {
                        return {
                            querySelector: (inner: string) => {
                                if (inner === 'a[href^="/"]') {
                                    return { getAttribute: (name: string) => name === 'href' ? '/mainuser' : null };
                                }
                                if (inner === 'span') {
                    ...
                    if (s === 'a[href*="/status/"]') {
                        return { getAttribute: (name: string) => name === 'href' ? '/mainuser/status/111' : null };
                    }
                    return null;
                },
                querySelectorAll: (s) => {
            ...
            expect(result!.attachments[0].src).toBe('https://pbs.twimg.com/media/IMG456.jpg');
                ...
                querySelector: (s) => {
                    ...
                    if (s === '[data-testid="User-Name"]') {
                        return {
                            querySelector: (inner: string) => {
                                if (inner === 'a[href^="/"]') {
                                    return { getAttribute: (name: string) => name === 'href' ? '/lateuser' : null };
                                }
                                if (inner === 'span') {
                    ...
                    if (s === 'a[href*="/status/"]') {
                        return { getAttribute: (name: string) => name === 'href' ? '/lateuser/status/999' : null };
                    }
                    return null;
                },
                querySelectorAll: (s) => {
        ...
        it('extracts image src from background-image when img src is unavailable', async () => {
            ...
            const photoContainer = {
                ...
                querySelectorAll: (sel: string) => (sel === '[style*="background-image"]' ? [backgroundNode] : []),
                getAttribute: (_name: string) => null,
            };
                ...
                querySelector: (s) => {
                    ...
                    if (s === '[data-testid="User-Name"]') {
                        return {
                            querySelector: (inner: string) => {
                                if (inner === 'a[href^="/"]') {
                                    return { getAttribute: (name: string) => name === 'href' ? '/bguser' : null };
                                }
                                if (inner === 'span') {
                    ...
                    if (s === 'a[href*="/status/"]') {
                        return { getAttribute: (name: string) => name === 'href' ? '/bguser/status/222' : null };
                    }
                    return null;
                },
                querySelectorAll: (s) => {
